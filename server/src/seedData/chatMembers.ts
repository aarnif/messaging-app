...
const chatMembers: ChatMember[] = [
  ...
  { userId: 1, chatId: 2, role: "admin" },
  { userId: 3, chatId: 2, role: "member" },
  { userId: 9, chatId: 2, role: "member" },
  { userId: 10, chatId: 2, role: "member" },

  { userId: 1, chatId: 3, role: "admin" },
  { userId: 4, chatId: 3, role: "member" },
  ...
  { userId: 11, chatId: 5, role: "member" },
